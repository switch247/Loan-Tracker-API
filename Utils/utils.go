...
// func ExtractUser(c *gin.Context) (Dtos.OmitedUser, error) {
// 	userID, ok := c.Get("user_id")
// 	if !ok {
// 		return Dtos.OmitedUser{}, errors.New("Failed to retrieve user ID")
// 	}
// 	UserobjectID, err := primitive.ObjectIDFromHex(userID.(string))
// 	if err != nil {
// 		return Dtos.OmitedUser{}, errors.New("invalid user ID")
// 	}
// 	is_admin, ok := c.Get("is_admin")
// 	if !ok {

// 		return Dtos.OmitedUser{}, errors.New("Failed to retrieve role")
// 	}

// 	return Dtos.OmitedUser{
// 		ID: UserobjectID,
